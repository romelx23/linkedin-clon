...
export const NotificationScreen = () => {
  return <div>
      ...
      <div className="bg-blue-700 min-h-screen pt-3">
        <div className="lg:flex lg:justify-center lg:items-start lg:flex-row flex flex-col items-center gap-2 text-white">
            <div className="w-64 h-56 mr-5 bg-blue-300 rounded-md flex flex-col justify-between">
              ...
              <div className="bg-gray-400 py-4 rounded-b-md">
                ...
                <button className='text-blue-600 font-semibold'>Ver Configuración</button>
              </div>
            </div>
